...
insert into t_city(city, province_id, display_order) values('赤峰',33,0);
...
#信达渠道
INSERT INTO t_agent(name, contacts, mobile, mail, note, timex) VALUES ('未分配', 'wu', '13527206719', '296947440@qq.com', '广东 珠海', '2017-03-31 09:09:09');
INSERT INTO t_agent(name, contacts, mobile, mail, note, timex) VALUES ('信达九州', 'wu', '13527206719', '296947440@qq.com', '广东 珠海', '2017-03-31 09:09:09');
INSERT INTO t_account VALUES ('admin', 2,  '9806fc19405e136195fab8da8e2f922faf019430', 'wu', 0, 5351124,  '771412508@qq.com', 0, '2017-03-31 09:09:09');
insert into t_account_roles values(0, 'admin');


select count(1)  from t_customer t1 
	where t1.agent_id = 1 and t1.enabled = 0;
